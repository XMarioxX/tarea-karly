...
const CauchyEulerEjercicio2 = () => {
  // Datos para la solución y = 16x² + 16x⁻²
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      content: [
        {
          text: "Resolvemos el sistema de ecuaciones:",
          math: [
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto bg-gradient-to-b">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <Chart 
          data={solutionData} 
          title="Solución y(x) con punto inicial y(2) = 32" 
          point={point1}
          yLabel="y(x)"
        />
        <Chart 
          data={derivativeData} 
          title="Derivada y'(x) con punto inicial y'(2) = 0" 
          point={point2}
          yLabel="y'(x)"
        />
      </div>
...
export default CauchyEulerEjercicio2;